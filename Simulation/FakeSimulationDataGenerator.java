...
public class FakeSimulationDataGenerator {
    ...
    public static void main(String[] args) {
        ...
        try (FileWriter writer = new FileWriter(fileName)) {
            ...
            for (int t = 1; t <= timePoints; t++) {
                ...
                writer.write("Time point " + t + "\n");
                writer.write("ticksSinceStart " + ticksSinceStart + "\n");
                writer.write("colonyCentre: " + colonyX + ", " + colonyY + "\n");
